...
public class GooView extends View {
    ...
    private int   mDevideNum         = 7;// 将屏幕分成几份
    ...
    private void init() {
        ...
        mScreenmWidth = wm.getDefaultDisplay().getWidth();
        mScreenHeight = wm.getDefaultDisplay().getHeight();

        mStaicRadius = mScreenmWidth / 7;
        mMoveRadius = mScreenmWidth / 7;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d("GooView", tempStaticRadius + "jiaodu");
...
*/
    ...
    public void updateMoveCenter(float downX, float downY) {
        int which = (int) (downX / mStaicRadius);        //哪个方块
        float blockX = downX + mStaicRadius * which;
        float blockY= downY + mStaicRadius * which;
        mMovewCenter.set(blockX, blockY);
        invalidate();
    }
